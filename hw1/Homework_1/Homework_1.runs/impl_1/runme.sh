...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw1/Homework_1/Homework_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log orand.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source orand.tcl -notrace
