...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw1/Homework_1/Homework_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log orand.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source orand.tcl
