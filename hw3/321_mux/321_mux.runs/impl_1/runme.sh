...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw3/321_mux/321_mux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_31.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_31.tcl -notrace
