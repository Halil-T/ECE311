...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw3/Gates_mux/Gates_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_gates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_gates.tcl
