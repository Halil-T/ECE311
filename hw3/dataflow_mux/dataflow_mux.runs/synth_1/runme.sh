...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw3/dataflow_mux/dataflow_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_dataflow.tcl
