...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw3/ripple_adder/ripple_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ripple_adder.tcl
