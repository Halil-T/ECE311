...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw4/3-8Decoder/3-8Decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder3_8.tcl -notrace
