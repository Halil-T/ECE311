...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw4/3-8Decoder/3-8Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder3_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder3_8.tcl
