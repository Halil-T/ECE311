...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw4/IC chip/IC chip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chip.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source chip.tcl -notrace
