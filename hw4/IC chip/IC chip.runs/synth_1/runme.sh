...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw4/IC chip/IC chip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chip.tcl
