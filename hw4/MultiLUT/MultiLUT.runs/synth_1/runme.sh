...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw4/MultiLUT/MultiLUT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiLUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiLUT.tcl
