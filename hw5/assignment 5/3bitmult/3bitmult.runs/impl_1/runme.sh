...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw5/3bitmult/3bitmult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult3.tcl -notrace
