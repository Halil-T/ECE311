...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw5/3bitmult/3bitmult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult3.tcl
