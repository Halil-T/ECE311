...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw5/assignment 5/reg4/reg4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reg4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reg4.tcl -notrace
