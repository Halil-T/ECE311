...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw5/assignment 5/reg4/reg4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg4.tcl
