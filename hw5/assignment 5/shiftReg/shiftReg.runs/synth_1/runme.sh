...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/Documents/ECE311/hw5/assignment 5/shiftReg/shiftReg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shiftReg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shiftReg.tcl
