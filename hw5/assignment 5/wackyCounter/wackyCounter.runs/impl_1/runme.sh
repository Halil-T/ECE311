...
HD_PWD='/afs/ee.cooper.edu/user/h/halil.turan/wackyCounter/wackyCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log count.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source count.tcl -notrace
